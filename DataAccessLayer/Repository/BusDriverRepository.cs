...
namespace DataAccessLayer.Repository
{
    public class BusDriverRepository : IBusDriverRepository
    {
        ...
        public BusDriver GetBusDriver(int driverId, string password)
        {
            ...
            var cmdGetBusDriver =
                new SqlCommand(
                    "SELECT busDriverId FROM Drv_busDriverCredential WHERE busDriverId = @driverId and password = @password",
                    conn);
